...
--ner-column, --split, --trust-remote-code, and --generate-label-embeddings.
"""
...
def main(
    ...
    trust_remote_code: bool = typer.Option(
        False,
        help="Allow execution of custom code from remote model repositories when loading models.",
    ),
    ...
    if generate_label_embeddings:
        ...
        model = GLiNER.from_pretrained(generate_label_embeddings, trust_remote_code=trust_remote_code)
