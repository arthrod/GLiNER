...
class TestSpanDecoder:
    ...
    def basic_inputs(self):
        ...
        tokens = [["The", "quick", "brown", "fox", "jumps"], ["Hello", "world", "test", "sentence", "here"]]
    ...
    def test_span_tuple_format(self, basic_config, basic_inputs):
        """Should return spans as Span dataclass with correct attributes."""
        decoder = SpanDecoder(basic_config)
    ...
    def test_per_sample_id_to_classes(self, basic_config, basic_inputs):
        ...
        id_to_classes_list = [{1: "PERSON", 2: "ORG"}, {1: "LOCATION", 2: "DATE"}]
    ...
    def test_empty_predictions(self, basic_config):
        ...
        result = decoder.decode(tokens=tokens, id_to_classes=id_to_classes, model_output=logits, threshold=0.5)
...
class TestSpanGenerativeDecoder:
    ...
    def test_prompt_mode_replaces_class_names(self, prompt_mode_config, generative_inputs):
        ...
        for batch_spans in result:
            for span in batch_spans:
                # In prompt mode, entity_type is the generated label
    ...
    def test_span_mode_adds_generated_labels(self, span_mode_config, generative_inputs):
        ...
        # In span mode, Spans should have generated_labels attribute
        for batch_spans in result:
            for span in batch_spans:
                assert isinstance(span, Span)
    ...
    def test_update_id_to_classes_with_generated(self, prompt_mode_config):
        ...
        result = decoder._update_id_to_classes_with_generated(id_to_classes, gen_labels, batch_size)
    ...
    def test_build_span_label_map_for_batch(self, span_mode_config):
        ...
        result = decoder._build_span_label_map_for_batch(sel_idx, gen_labels, num_gen_sequences)
    ...
    def test_fallback_to_standard_decoding(self, prompt_mode_config, generative_inputs):
        ...
        for batch_spans in result:
            for span in batch_spans:
                # Standard format returns Span with generated_labels=None
                assert isinstance(span, Span)
                assert span.generated_labels is None  # No generated labels provided
...
class TestSpanRelexDecoder:
    ...
    def relex_inputs(self):
        ...
        logits.rel_mask = torch.tensor([[True, True, False, False], [True, False, False, False]])
...
class TestTokenDecoder:
    ...
    def test_validates_inside_scores(self, token_config):
        ...
        result = decoder.decode(tokens=tokens, id_to_classes=id_to_classes, model_output=model_output, threshold=0.5)
...
class TestGreedySearch:
    ...
    def test_sorts_by_start_position(self, basic_decoder):
        ...
        spans = [Span(5, 7, "LOCATION", 0.9), Span(0, 2, "PERSON", 0.8), Span(10, 12, "ORG", 0.7)]
